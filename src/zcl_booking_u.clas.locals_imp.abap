    ...
    LOOP AT it_booking_update ASSIGNING FIELD-SYMBOL(<fs_booking_update>).
      CALL FUNCTION '/DMO/FLIGHT_TRAVEL_UPDATE'
        EXPORTING
          ...
          it_booking  = VALUE /dmo/if_flight_legacy=>tt_booking_in( ( Zcl_travel_auxilliary=>map_booking_cds_to_db( CORRESPONDING #( <fs_booking_update> ) ) ) )
...
**********************************************************************
* Helper method:
* Indicates the booking fields that have been changed by the consumer
**********************************************************************
