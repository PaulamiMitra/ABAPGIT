...
define root view Z_I_Travel_U as select from /dmo/travel as Travel 

  composition [0..*] of z_I_Booking_U as _Booking

  association [0..1] to Z_I_Agency_U   as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to Z_I_Customer_U as _Customer  on $projection.CustomerID      = _Customer.CustomerID
